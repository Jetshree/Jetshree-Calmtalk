...
export default function Footer() {
  ...
  return (
    <div className='footer-con w-full bg-black text-white p-6'>
      ...
      <div className='copyrights text-center mt-10'>
        <span className='text-sm'><i className="fa-regular fa-copyright"></i> All rights reserved by CalmTalk</span>
      </div>
    </div>
  )
}